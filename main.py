print("welcome to the dungon. You cannot go back through the same way you came because the door is bulted shut from the outside. Your welcome for that by the way. You must find a way to escape. The only tool you have is your axe, if you ever want to use your axe type -axe-")
